...
#The dictionary golds contains information about how many gold medals each country won in the 
#2016 Olympics. But today, Spain won 2 more gold medals. Update golds to reflect this information.
...
#at the halfway point in the 2016 Rio Olympics. Using dictionary mechanics, assign the medal 
#count value for "Belarus" to the variable belarus. Do not hardcode this.

medal_count = {'United States': 70, 'Great Britain':38, 'China':45, 'Russia':30, 'Germany':17, 'Italy':22, 'France': 22, 'Japan':26, 'Australia':22, 'South Korea':14, 'Hungary':12, 'Netherlands':10, 'Spain':5, 'New Zealand':8, 'Canada':13, 'Kazakhstan':8, 'Colombia':4, 'Switzerland':5, 'Belgium':4, 'Thailand':4, 'Croatia':3, 'Iran':3, 'Jamaica':3, 'South Africa':7, 'Sweden':6, 'Denmark':7, 'North Korea':6, 'Kenya':4, 'Brazil':7, 'Belarus':4, 'Cuba':5, 'Poland':4, 'Romania':4, 'Slovenia':3, 'Argentina':2, 'Bahrain':2, 'Slovakia':2, 'Vietnam':2, 'Czech Republic':6, 'Uzbekistan':5}
belarus = medal_count.get("Belarus")
print(belarus)

#The dictionary total_golds contains the total number of gold medals that countries have won 
#over the course of history. Use dictionary mechanics to find the number of golds Chile has won, 
...
#has won in 2016, and in which category they have won it in. Using dictionary mechanics, assign 
#the value of the key "Fencing" to a variable fencing_value. Remember, do not hard code this.
...
#The dictionary Junior shows a schedule for a junior year semester. The key is the course 
#name and the value is the number of credits. Find the total number of credits taken this 
#semester and assign it to the variable credits. Do not hardcode this – use dictionary accumulation!
...
#Provided is a string saved to the variable name s1. Create a dictionary named counts 
...
#Create the dictionary characters that shows each character from the string sally and 
#its frequency. Then, find the most frequent letter based on the dictionary. Assign this 
#letter to the variable best_char.
...
#Create a dictionary named letter_counts that contains each letter and the number of times 
#it occurs in string1. Challenge: Letters should not be counted separately as upper-case and 
#lower-case. Intead, all of them should be counted as lower-case.
...
#Create a dictionary called low_d that keeps track of all the characters in the string p and 
#notes how many times each character was seen. Make sure that there are no repeats of characters 
#as keys, such that “T” and “t” are both seen as a “t” for example.
